...
<div>
    ...
    <ul style="list-style-type: none; padding-left: 0;">
        ...
        <li style="margin-bottom: 8px; color: #36454F;">📝 데이터베이스 책 사기</li>
...
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| | | | **1**<br><sub>- DB 공부</sub><br><sub>- 알고리즘 공부</sub><br><sub>- 단국대 컨텍 면담</sub><br><sub>- 객체 정의 완료</sub> | **2**<br><sub>- 깃 홈페이지 구성</sub><br><sub>- python 공부</sub><br><sub>- DB 공부</sub> | **3**<br> | **4**<br> |
